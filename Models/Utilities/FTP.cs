...
namespace RoutledgeAssignmentFour.Models.Utilities
{
    ...
    public class FTPUpload
    {
        ...
        public static string CreateFileOnFTP(byte[] fileContents, string destinationFileUrl, string username = Constants.FTP.UserName, string password = Constants.FTP.Password)
        {
            string output;
            ...
            // Use the bytes of the file passed into this function
            //Get the length or size of the file
            request.ContentLength = fileContents.Length;
